...
<style>
    ...
    .image-removed-warning i {
        color: #f39c12;
        font-size: 16px;
    }
    
    .image-removed-warning.alert-warning {
    ...
    .form-group label small.optional-text {
        margin-left: 8px;
        padding: 2px 8px;
                        ...
                        <table class="table table-centered table-nowrap table-striped" id="banner-datatable">
                            ...
                            <tbody id="post_list">
                                ...
                                <tr data-row-id="{{$ban->id}}">
                                    ...
                                    <td>
                                        @if($ban->language)
                                            <span class="badge badge-soft-primary">{{ $ban->language->name }}</span>
                                        @else
                                            <span class="badge badge-soft-secondary">{{ __("Not Set") }}</span>
                                        @endif
                                    </td> 
