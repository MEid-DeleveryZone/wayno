...
use App\Http\Controllers\Client\ProductInquiryController;
...
Route::group(['middleware' => 'adminLanguageSwitch'], function () {
    Route::group(['middleware' => ['ClientAuth', 'database'], 'prefix' => '/client'], function () {
        ...
        Route::post('brandProductsCheck', 'Client\BrandController@brandProductsCheck')->name('brandProductsCheck');
        ...
        Route::get('cancelReason/{id}', 'Client\ClientPreferenceController@getCancelReason')->name('cancelReason.show');
        Route::get('cancelReason/{id}/edit', 'Client\ClientPreferenceController@editCancelReason')->name('cancelReason.edit');
        Route::post('cancelReason/create', 'Client\ClientPreferenceController@addEditCancelReason')->name('cancelReason.createUpdate');
        Route::post('cancelReason/delete', 'Client\ClientPreferenceController@deleteCancelReason')->name('cancelReason.delete');
        ...
        Route::post('vendor/addItemCategory', 'Client\VendorController@addItemCategory')->name('vendor.addItemCategory');
        Route::post('vendor/editItemCategory', 'Client\VendorController@editItemCategory')->name('vendor.editItemCategory');
        Route::post('vendor/deleteItemCategory', 'Client\VendorController@deleteItemCategory')->name('vendor.deleteItemCategory');
        ...
        Route::post('product/importUploadCSV', 'Client\ProductController@importUploadCsv')->name('product.importUpload');
        ...
        Route::post('checkEnabledinVendor', 'Client\PaymentOptionController@checkEnabledinVendor')->name('payoption.checkEnabledinVendor');
        ...
        Route::post('max-return-days', 'Client\ClientPreferenceController@updateMaxReturnDays')->name('max-return-days.update');
    });
});
